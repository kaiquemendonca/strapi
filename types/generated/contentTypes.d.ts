...
export interface ApiDisabledDateDisabledDate
  extends Struct.CollectionTypeSchema {
  collectionName: 'disabled_dates';
  info: {
    displayName: 'Disabled Date';
    pluralName: 'disabled-dates';
    singularName: 'disabled-date';
  };
  options: {
    draftAndPublish: true;
  };
  attributes: {
    ...
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::disabled-date.disabled-date'
    > &
      Schema.Attribute.Private;
    publishedAt: Schema.Attribute.DateTime;
...
export interface ApiOrderOrder extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    estado: Schema.Attribute.Enumeration<['Pendente', 'Pago', 'Cancelado']>;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<'oneToMany', 'api::order.order'> &
      Schema.Attribute.Private;
    paymentMethod: Schema.Attribute.Enumeration<['PIX', 'Cart\u00E3o']>;
    publishedAt: Schema.Attribute.DateTime;
    totalAmount: Schema.Attribute.Decimal;
    tours: Schema.Attribute.Relation<'manyToMany', 'api::client.client'>;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
  };
...
declare module '@strapi/strapi' {
  export module Public {
    export interface ContentTypeSchemas {
      ...
      'api::disabled-date.disabled-date': ApiDisabledDateDisabledDate;
